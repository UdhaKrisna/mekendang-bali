...
<body class="d-flex flex-column bg-light min-vh-100">
    ...
    <div class="container py-4">
        <div class="row">
            @foreach ($list as $index => $k)
                <div class="col-6 col-sm-3">
                    <div class="card-deck">
                        <div class="card shadow mt-3">
                            <div class="card-body text-center">
                                <h3 class="card-title fw-bold" style="color: #805424;">{{ $k['name'] }}</h3>
                                <p class="text-center fw-bold">Jumlah : {{ $k['total'] }}</p>
                                <a href="{{ $k['id'] == 'TeknikPermainan' || $k['id'] == 'BahanPembuatan' ? route('penjelajahan-kriteria', $k['id']) : route('penjelajahan-list-kriteria', $k['id']) }}"
